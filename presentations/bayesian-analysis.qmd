...
# What is statistical analysis for?
...
![](images/more-data-1.png){.absolute bottom=-60 left=410 width=600 .fragment .fade-in-then-out fragment-index=4}

![](images/more-data-2.png){.absolute bottom=-60 left=410 width=600 .fragment .fade-in-then-out fragment-index=5}

![](images/more-data-3.png){.absolute bottom=-60 left=410 width=600 .fragment fragment-index=6}
...
* Confidence intervals
  * Slightly more subtle differences
...
* Bayesian analyses are often more complex than classical analyses, and care is needed in presentation and interpretation
...
* Bayesian analysis produces an estimated parameter *distribution*, not a single point estimate
  ...
  * The 2.5th and 97.5th percentiles of the distribution can be used to generate a 95% credible interval
